...
import AnimatedSection from "./_sections/animated-section";
						...
						<AnimatedSection delay={0.2} direction="left">
							<div className="col-span-1">
								...
								<p className="text-2xl lg:mb-12 mb-6">
									Mani Group was founded with one core belief – of building
									homes for people who believe in quality. Over the last four
									decades, we have delivered more than 30 million sq. ft to more
									than 5000+ families…
								</p>
