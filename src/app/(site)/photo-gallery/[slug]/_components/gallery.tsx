...
import { PhotoGalleryAlbumInfo } from "@/types/api/photo-gallery";
import { cn } from "@/lib/utils";
import Image from "next/image";
import m2 from "@/app/_assets/mock/m2.png";

const Gallery: React.FC<{
	data: PhotoGalleryAlbumInfo[];
	className?: string;
}> = ({ data, className, ...rest }) => {
	...
	return (
		<div
			className={cn(
				"grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4",
				className
			)}
			{...rest}
		>
